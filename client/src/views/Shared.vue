...
<template>
  <div>
      ...
      <li v-for="g in collab.shared" :key="g.id" class="list-group-item">
        <div class="d-flex justify-content-between">
          <div class="w-100">
            ...
            <CheckinsPanel :goal-id="g.id" :compact="true" :permissions="getPerm(g)" />
          </div>
        </div>
      </li>
    </ul>
    ...
    <div class="d-flex justify-content-between align-items-center mt-3">
      ...
      <div class="btn-group">
        <button class="btn btn-outline-secondary" :disabled="collab.sharedPage <= 1" @click="prev">
          Prev
        </button>
        <button
          class="btn btn-outline-secondary"
          :disabled="collab.sharedPage >= collab.sharedPages"
          @click="next"
        >
          Next
        </button>
